...
export default function NewsList({ 
  ...
  return (    <>
    ...
    <div className="relative min-h-screen">
      <div className="space-y-4 pb-[10px] font-sans" id="news-catalog-root-wrapper">
          ...
          if (section.id.startsWith('custom_')) {
            ...
            cardContent = (
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[10px]">
                ...
                <div className="border-b border-slate-800 mb-[15px] flex items-end overflow-x-auto scrollbar-none gap-6 pb-1">
                    ...
                    <div className="md:col-span-5 lg:col-span-5 bg-[#0e121b] border border-[#232d45] rounded overflow-hidden flex flex-col group cursor-pointer hover:border-amber-500 transition-colors">
                      <div className="h-[260px] overflow-hidden relative">
                        <img
                          ...
                          onClick={() => displayArticle && onNavigate({ screen: 'news-detail', newsId: displayArticle.id })}
                        ...
                        {trendingNews.slice(0, 5).map((article) => (
                          ...
                          >
                            <div className="w-[70px] h-[50px] shrink-0 rounded overflow-hidden border border-white/10">
                              <img src={(article.imageUrl) || undefined} alt={`Ảnh thu nhỏ bài viết: ${article.title}`} className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                            </div>
                      ...
                      {interestNews.map((article) => (
                        ...
                        >
                          <div className="w-[90px] h-[65px] rounded overflow-hidden shrink-0 border border-[#232d45] relative">
                            <img src={(article.imageUrl) || undefined} alt={article.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500 block" referrerPolicy="no-referrer" />
                          </div>
                            ...
                            {sec.items.map((p: any) => (
                              ...
                              >
                                <div className="w-[100px] h-[85px] shrink-0 rounded overflow-hidden border border-[#232d45] relative">
                                  ...
                                  <img src={(p.imageUrl) || undefined} alt={p.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500 block" referrerPolicy="no-referrer" />
                                </div>
