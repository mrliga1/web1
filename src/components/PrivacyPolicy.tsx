    ...
    <div className="bg-slate-950 font-sans text-slate-300 min-h-screen">
      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-emerald-500 font-serif mb-6 tracking-tight">Chính Sách Bảo Mật Dữ Liệu</h1>
        ...
        <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 md:p-10 shadow-xl space-y-8 prose prose-invert max-w-none prose-emerald">
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4">1. Thu thập thông tin cá nhân</h2>
            ...
            <ul className="list-disc pl-5 space-y-2 text-slate-300 text-sm md:text-base mt-3 marker:text-emerald-500/50">
              <li>Họ và tên</li>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4">2. Mục đích sử dụng dữ liệu</h2>
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4">3. Chia sẻ thông tin</h2>
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
              Greenia Homes <strong className="text-white font-medium">CAM KẾT KHÔNG</strong> bán, trao đổi hoặc chia sẻ dữ liệu cá nhân của bạn với bất kỳ bên thứ ba vì mục đích thương mại tiếp thị độc lập. Dữ liệu chỉ được chia sẻ trong trường hợp có sự yêu cầu từ Cơ quan pháp luật theo điều lệ của nhà nước.
            </p>
          </section>

          <section>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4">4. Cookie & Theo dõi kỹ thuật số</h2>
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4">5. Lưu trữ & Bảo mật</h2>
            <p className="text-slate-300 leading-relaxed text-sm md:text-base">
          ...
          <div className="pt-8 mt-12 border-t border-slate-800">
             <p className="text-sm text-slate-500 italic">Văn bản có mục đích tham khảo và thực thi ngay khi phát hành công khai. Nếu quý khách muốn gỡ bỏ dữ liệu khỏi hệ thống, vui lòng truy cập trang <button className="text-emerald-500 hover:text-emerald-400 font-medium hover:underline" onClick={() => onNavigate({ screen: 'lien-he' })}>Liên hệ</button> và gửi yêu cầu, chúng tôi sẽ xử lý ngay lập tức.</p>
          </div>
        </div>
