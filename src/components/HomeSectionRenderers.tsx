  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 items-center relative z-10 pt-[10px] pb-5">
        <div className="md:col-span-1 lg:col-span-7 space-y-6 text-left w-full sm:w-[332px] md:w-full max-w-full" id="banner-intro-txt">
          ...
          <div className="flex flex-row items-center gap-2 sm:gap-4 pt-[10px] -mb-[20px] w-full">
            <button
              ...
              className="flex items-center justify-center gap-1 sm:gap-2 bg-amber-500 hover:bg-amber-600 outline-none text-slate-950 font-semibold px-3 sm:px-[15px] py-2 sm:py-[5px] rounded-full text-[11px] sm:text-[12px] shadow-xl shadow-amber-500/10 cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition-all border-none whitespace-nowrap"
            >
          ...
          <div className="mt-[30px] pt-[15px] w-[320px] border-t border-slate-800/80 hidden sm:block">
            <p className="text-slate-500 text-[10px] uppercase font-bold tracking-[0.2em] mb-4">ĐỐI TÁC PHÂN PHỐI CHIẾN LƯỢC CAO CẤP CỦA</p>
            <div className="flex flex-wrap items-center gap-8 opacity-70">
              ...
              <div className="flex items-center gap-2 group cursor-pointer transition-all hover:opacity-100">
                <Layers className="w-[16px] h-[16px] text-slate-300 group-hover:text-amber-500 transition-colors" />
                <span className="font-display text-[14px] font-bold text-white tracking-widest uppercase">Masterise</span>
              </div>
            </div>
          </div>
        </div>

        <div className="md:col-span-1 lg:col-span-5 flex justify-end" id="hero-banner-consultation-form">
            ...
            {formSubmitted ? (
              <div className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-xl p-5 text-center space-y-3 animate-in zoom-in-95">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-emerald-200/70 mt-1.5 leading-relaxed">Bộ phận chăm sóc giới tinh hoa sẽ gọi đến cho quý khách trong vài phút tới qua Hotline hoặc số điện thoại {clientPhone}.</p>
                </div>
                <button
                  type="button"
                  onClick={() => setFormSubmitted(false)}
                  className="text-amber-400 text-xs font-semibold hover:underline border-none bg-transparent cursor-pointer pt-2 block mx-auto"
                >
              ...
              <form onSubmit={handleConsultationSubmit} className="p-[5px]">
                <div className="text-left mb-[5px]">
                  <input
                    ...
                    placeholder="Họ tên *"
                    className="w-full bg-slate-950/60 border border-slate-700/50 text-slate-200 text-[12px] h-[35.5px] px-3.5 pt-0 rounded-lg outline-none focus:border-amber-500/70 transition-colors"
                    required
                  />
                </div>
                <div className="text-left mb-[5px]">
                  <input
                    ...
                    className="w-full bg-slate-950/60 border border-slate-700/50 text-slate-200 text-[12px] px-3.5 h-[35.5px] rounded-lg outline-none focus:border-amber-500/70 transition-colors"
                    required
                  />
                </div>
                <div className="text-left mb-[5px]">
                ...
                <div className="text-left mb-[10px]">
                  <textarea
                    ...
                    rows={2}
                    className="w-full bg-slate-950/60 border border-slate-700/50 text-slate-200 text-[12px] px-3.5 py-[5px] h-[55px] rounded-lg outline-none focus:border-amber-500/70 transition-colors resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full my-0 mt-[14px] bg-[#2D3F75] hover:bg-[#384c8a] disabled:opacity-50 text-white font-semibold py-[5px] px-4 rounded-lg text-[13px] md:text-sm transition-all cursor-pointer text-center"
                >
...
export const CorporateIntroBody: React.FC<SectionRendererProps> = ({
  ...
  return (
    <section className="bg-slate-900/30 border-y border-slate-900 pt-[10px] pb-[20px] font-sans" id="home-corporate-intro">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[20px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          {/* Vision */}
          <div className="bg-slate-900/60 border border-slate-800 p-[12px] rounded-xl hover:border-amber-500/30 hover:bg-slate-900 shadow-xl transition-all group relative overflow-hidden">
            <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
              <Compass className="w-24 h-24" />
            </div>
            <div className="w-[35px] h-[35px] mb-[10px] bg-gradient-to-br from-amber-500/20 to-amber-500/5 border border-amber-500/20 text-amber-400 flex items-center justify-center rounded-lg group-hover:scale-110 transition-transform">
            ...
            <EditableText 
              ...
              sections={sections}
              onUpdateSections={onUpdateSections}
              className="font-display font-bold text-lg text-white mb-[5px]" 
              tag="h3" 
            />
            <EditableText 
              sectionId="corporate_intro" 
          ...
          {/* Working Process */}
          <div className="bg-slate-900/60 border border-slate-800 pt-[12px] pl-[11px] pr-[12px] pb-[10px] rounded-xl hover:border-amber-500/30 hover:bg-slate-900 shadow-xl transition-all group relative overflow-hidden">
            <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 items-center">
        <div className="md:col-span-1 lg:col-span-6 space-y-6 text-left">
          <EditableText 
            ...
            sections={sections}
            onUpdateSections={onUpdateSections}
            className="text-[25px] font-display font-medium text-white tracking-tight leading-tight" 
            tag="h2" 
          />
          <EditableText 
            sectionId="reasons" 
          ...
          <div className="space-y-6 pt-[0px] w-full sm:w-[360px] max-w-full">
            <div className="flex items-start gap-4 p-[10px] mb-[5px] rounded-xl hover:bg-slate-900/50 transition-colors border border-transparent hover:border-slate-800">
              <div className="bg-gradient-to-br from-amber-500/20 to-amber-500/5 w-10 h-10 rounded-full flex items-center justify-center text-amber-500 font-bold font-mono text-sm shrink-0 border border-amber-500/20 shadow-inner">01</div>
              <div>
                <EditableText 
                  sectionId="reasons" 
                  field="extraData" 
                ...
                <EditableText 
                  ...
                  onUpdateSections={onUpdateSections}
                  isArea 
                  className="text-slate-400 text-xs font-light mt-1.5 leading-relaxed" 
                  tag="p" 
                />
              </div>
            </div>

            <div className="flex items-start gap-4 p-[10px] mb-[10px] rounded-xl hover:bg-slate-900/50 transition-colors border border-transparent hover:border-slate-800">
              <div className="bg-gradient-to-br from-amber-500/20 to-amber-500/5 w-10 h-10 rounded-full flex items-center justify-center text-amber-500 font-bold font-mono text-sm shrink-0 border border-amber-500/20 shadow-inner">02</div>
              <div>
                <EditableText 
                  sectionId="reasons" 
                  field="extraData" 
            ...
            <div className="flex items-start gap-4 p-[10px] rounded-xl hover:bg-slate-900/50 transition-colors border border-transparent hover:border-slate-800">
              <div className="bg-gradient-to-br from-amber-500/20 to-amber-500/5 w-10 h-10 rounded-full flex items-center justify-center text-amber-500 font-bold font-mono text-sm shrink-0 border border-amber-500/20 shadow-inner">03</div>
              <div>
                <EditableText 
                  sectionId="reasons" 
                  field="extraData" 
        ...
        <div className="md:col-span-1 lg:col-span-6 grid grid-cols-2 gap-4 lg:w-[475px] lg:mx-auto" id="numbers-choose">
          <div className="bg-slate-900/80 p-[10px] sm:p-[12px] w-full sm:w-[160px] lg:w-[200px] h-auto sm:h-[195px] lg:h-[160px] rounded-2xl border border-slate-800 shadow-xl space-y-3 text-left hover:border-amber-500/30 transition-colors col-span-1">
            <EditableText 
              sectionId="reasons" 
              field="extraData" 
              subField="stat1Val" 
              ...
              sections={sections}
              onUpdateSections={onUpdateSections}
              className="text-[20px] sm:text-[30px] font-bold font-display text-amber-500 inline-block mb-1" 
              tag="h3" 
            />
            <EditableText 
              sectionId="reasons" 
              ...
              sections={sections}
              onUpdateSections={onUpdateSections}
              className="mb-[5px] sm:mb-0 text-white tracking-widest uppercase text-[9px] sm:text-[10px] font-bold" 
              tag="p" 
            />
            <EditableText 
              sectionId="reasons" 
              ...
              onUpdateSections={onUpdateSections}
              isArea 
              className="text-slate-400 text-[10px] sm:text-xs font-light leading-relaxed pt-[5px] sm:pt-2" 
              tag="p" 
            />
          </div>

          <div className="bg-slate-900/80 p-[10px] sm:p-[12px] w-full sm:w-[160px] lg:w-[210px] h-auto sm:h-[195px] lg:h-[160px] rounded-2xl border border-slate-800 shadow-xl space-y-3 text-left hover:border-amber-500/30 transition-colors col-span-1">
            <EditableText 
              sectionId="reasons" 
              field="extraData" 
              subField="stat2Val" 
          ...
          <div className="bg-slate-900/80 p-[10px] sm:p-[12px] w-full sm:w-[327px] lg:w-[450px] lg:h-[146px] rounded-2xl border border-slate-800 shadow-xl space-y-3 text-left col-span-2 hover:border-amber-500/30 transition-colors">
            <EditableText 
              sectionId="reasons" 
              field="extraData" 
              subField="stat3Val" 
              ...
              sections={sections}
              onUpdateSections={onUpdateSections}
              className="text-[25px] sm:text-[30px] font-bold font-display text-amber-500 inline-block mb-1" 
              tag="h3" 
            />
            <EditableText 
              sectionId="reasons" 
              ...
              sections={sections}
              onUpdateSections={onUpdateSections}
              className="mb-[5px] sm:mb-0 text-white tracking-widest uppercase text-[10px] font-bold" 
              tag="p" 
            />
            <EditableText 
              sectionId="reasons" 
              ...
              onUpdateSections={onUpdateSections}
              isArea 
              className="text-slate-400 text-[10px] sm:text-xs font-light leading-relaxed pt-[5px] sm:pt-2 max-w-lg" 
              tag="p" 
            />
          </div>
        </div>
...
export const FeaturedListingsBody: React.FC<ListingsProps> = ({
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 pt-[10px] pb-[10px] font-sans" id="home-grid-products">
      <div className="flex flex-row items-center justify-between gap-4 text-left border-b border-slate-800 pb-[5px] mb-[16px]">
        <div>
          <EditableText 
        ...
        <div className="flex items-center shrink-0">
          <button 
            ...
            className="text-amber-400 hover:text-amber-300 font-sans text-xs font-semibold flex items-center gap-1 transition-colors cursor-pointer"
          >
          ...
          <div className="relative overflow-hidden py-4 w-full">
            <style>{`
              ...
              .animate-slider-projects {
                animation: sliderScrollProjects 25s linear infinite;
              }
              ...
              <div className="flex w-max animate-slider-projects">
                {[...Array(6)].flatMap(() => projects.slice(0, 4)).map((proj, idx) => (
                  <div
                    ...
                    className="w-[280px] sm:w-[320px] lg:w-[289px] shrink-0 mr-4 lg:mr-5 bg-slate-950 hover:bg-slate-900 border border-slate-850 hover:border-amber-500/20 rounded-lg overflow-hidden group hover:scale-[1.01] transition-all cursor-pointer flex flex-col justify-between"
                  >
      ...
      {news.length === 0 ? (
        ...
        <div className="relative overflow-hidden py-4 w-full">
          <style>{`
            ...
            .animate-slider-news {
              animation: sliderScrollNews 35s linear infinite;
            }
            ...
            <div className="flex w-max animate-slider-news">
              {[...Array(6)].flatMap(() => news.slice(0, 5)).map((article, idx) => (
                <div
                  ...
                  className="w-[280px] md:w-[220px] lg:w-[227px] shrink-0 mr-4 lg:mr-5 bg-slate-900/40 hover:bg-slate-900 border border-slate-850 hover:border-amber-500/20 rounded-lg overflow-hidden group hover:scale-[1.01] transition-all cursor-pointer flex flex-col justify-between"
                >
                  <div className="relative aspect-[16/10] overflow-hidden">
                    <img loading="lazy" decoding="async"
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                    ...
                    <div className="pt-2 border-t border-slate-850 flex items-center justify-between text-[9px] text-slate-500">
                      <span></span>
                      <span className="text-amber-400 font-bold shrink-0">Xem thêm →</span>
                    </div>
                  </div>
                </div>
              ))}
