        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 text-left">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3 text-[13px] text-white/70">
              ...
              <li><Link href="/san-pham" className="text-white/70 hover:text-accent hover:translate-x-1 transition-all flex items-center gap-2 cursor-pointer bg-transparent border-none text-left"><span className="text-accent text-lg leading-none">›</span> Chuyển Nhượng</Link></li>
              ...
              <li className="pt-2"><Link href="/" className="text-white/70 hover:text-accent hover:translate-x-1 transition-all flex items-center gap-2 cursor-pointer bg-transparent border-none text-left"><span className="text-accent text-lg leading-none">›</span> Chính sách bảo mật</Link></li>
            </ul>
          </div>
          <div className="space-y-6">
            ...
            <ul className="space-y-3 text-[13px] text-white/70">
              ...
              <li><Link href="/san-pham" className="text-white/70 hover:text-accent hover:translate-x-1 transition-all flex items-center gap-2 cursor-pointer bg-transparent border-none text-left"><span className="text-accent text-lg leading-none">›</span> Chuyển Nhượng</Link></li>
              <li><Link href="/san-pham" className="text-white/70 hover:text-accent hover:translate-x-1 transition-all flex items-center gap-2 cursor-pointer bg-transparent border-none text-left"><span className="text-accent text-lg leading-none">›</span> Cho thuê</Link></li>
              <li><Link href="/san-pham" className="text-white/70 hover:text-accent hover:translate-x-1 transition-all flex items-center gap-2 cursor-pointer bg-transparent border-none text-left"><span className="text-accent text-lg leading-none">›</span> Căn Hộ</Link></li>
              <li className="pb-4 border-b border-white/10"><Link href="/san-pham" className="text-white/70 hover:text-accent hover:translate-x-1 transition-all flex items-center gap-2 cursor-pointer bg-transparent border-none text-left"><span className="text-accent text-lg leading-none">›</span> Nhà Phố - Biệt Thự</Link></li>
              <li className="pt-2"><Link href="/" className="text-white/70 hover:text-accent hover:translate-x-1 transition-all flex items-center gap-2 cursor-pointer bg-transparent border-none text-left"><span className="text-accent text-lg leading-none">›</span> Điều khoản sử dụng</Link></li>
            </ul>
          </div>
          <div className="space-y-6 lg:col-span-1 border-l border-border-inverse pl-0 lg:pl-10">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a href="https://www.facebook.com/greeniahomes" target="_blank" rel="noreferrer" aria-label="Facebook Greenia Homes" className="w-10 h-10 rounded-full border border-border-inverse flex items-center justify-center text-white/50 hover:bg-primary hover:text-text-inverse hover:border-primary hover:-translate-y-1 transition-all">
              ...
              <a href="https://www.youtube.com/@greeniahomes.vn" target="_blank" rel="noreferrer" aria-label="YouTube Greenia Homes" className="w-10 h-10 rounded-full border border-border-inverse flex items-center justify-center text-white/50 hover:bg-primary hover:text-text-inverse hover:border-primary hover:-translate-y-1 transition-all">
              ...
              <a href="https://www.tiktok.com/@greeniahomes.vn" target="_blank" rel="noreferrer" aria-label="TikTok Greenia Homes" className="w-10 h-10 rounded-full border border-border-inverse flex items-center justify-center text-white/50 hover:bg-primary hover:text-text-inverse hover:border-primary hover:-translate-y-1 transition-all">
              ...
              <a href="https://zalo.me/0932966700" target="_blank" rel="noreferrer" aria-label="Zalo Greenia Homes" className="w-10 h-10 rounded-full border border-border-inverse flex items-center justify-center text-white/50 hover:bg-primary hover:text-text-inverse hover:border-primary hover:-translate-y-1 transition-all">
