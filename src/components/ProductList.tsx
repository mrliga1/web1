...
export default function ProductList({ 
  ...
  return (    <>
    ...
    <div className="relative min-h-screen">
      <div className="pb-[0px] font-sans" id="product-hub-view-root">
        {sections.map((section, idx) => {
          ...
          if (section.id.startsWith('custom_')) {
            ...
            cardContent = (
              <div className="block max-w-7xl mx-auto px-0 mt-0">
                ...
                <div className="pt-0 pr-0 border-b border-amber-500/10 shadow-[0_10px_20px_rgba(0,0,0,0.5)] transition-all duration-300 z-50 relative m-0 p-0">
                  <div ref={navbarRef} className="flex items-center w-full relative m-0 px-[5px]">
                    ...
                    >
                      ...
                      `}</style>
                        <div onClick={(e) => e.stopPropagation()} className={`w-full md:hidden bg-slate-900 border border-amber-500/50 rounded-lg py-1 shadow-[0_10px_40px_rgba(0,0,0,0.9)] max-h-[350px] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-800 pointer-events-auto ${openDropdown === 'type' ? 'block' : 'hidden'} animate-in fade-in zoom-in-95 duration-200`}>
                        ...
                        <div onClick={(e) => e.stopPropagation()} className={`w-full md:w-[260px] bg-slate-900 border border-amber-500/50 rounded-lg py-1 shadow-[0_10px_40px_rgba(0,0,0,0.9)] max-h-[350px] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-800 pointer-events-auto ${openDropdown === 'district' ? 'block' : 'hidden'} animate-in fade-in zoom-in-95 duration-200`}>
                        ...
                        <div onClick={(e) => e.stopPropagation()} className={`w-full md:w-[260px] bg-slate-900 border border-amber-500/50 rounded-lg py-1 shadow-[0_10px_40px_rgba(0,0,0,0.9)] max-h-[350px] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-800 pointer-events-auto ${openDropdown === 'category' ? 'block' : 'hidden'} animate-in fade-in zoom-in-95 duration-200`}>
                             <button onClick={() => { setSelectedCategory('all'); setOpenDropdown(null); }} className={`w-full text-left px-4 py-2.5 md:py-2 text-[13px] md:text-xs border-none cursor-pointer flex justify-between items-center transition-colors border-b border-white/5 ${selectedCategory === 'all' ? 'bg-amber-500/10 text-amber-500 font-bold' : 'bg-transparent text-slate-300 hover:bg-amber-500/10 hover:text-amber-500 hover:font-bold'}`}>
                             ...
                             {productCategoriesExt.map(cat => (
                               <button 
                                 ...
                                 className={`w-full text-left py-2.5 md:py-2 text-[13px] md:text-xs border-none cursor-pointer flex justify-between items-center transition-colors border-b border-white/5 ${cat.parentId ? 'px-8 text-[12px] md:text-[11px]' : 'px-4'} ${selectedCategory === cat.name ? 'bg-amber-500/10 text-amber-500 font-bold' : 'bg-slate-900 text-slate-300 hover:bg-amber-500/10 hover:text-amber-500'}`}
                               >
                        ...
                        <div onClick={(e) => e.stopPropagation()} className={`w-full md:w-[260px] bg-slate-900 border border-amber-500/50 rounded-lg py-1 shadow-[0_10px_40px_rgba(0,0,0,0.9)] max-h-[350px] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-800 pointer-events-auto ${openDropdown === 'price' ? 'block' : 'hidden'} animate-in fade-in zoom-in-95 duration-200`}>
                        ...
                        <div onClick={(e) => e.stopPropagation()} className={`w-full md:w-[260px] bg-slate-900 border border-amber-500/50 rounded-lg py-1 shadow-[0_10px_40px_rgba(0,0,0,0.9)] max-h-[350px] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-800 pointer-events-auto ${openDropdown === 'area' ? 'block' : 'hidden'} animate-in fade-in zoom-in-95 duration-200`}>
                ...
                {(searchQuery || selectedDistrict !== 'all' || selectedPriceRange !== 'all' || selectedAreaRange !== 'all' || selectedType !== 'all' || selectedCategory !== 'all') && (
                  <div className="pt-[10px] pb-0 mb-[15px] text-white text-[12px] flex items-center border-b border-dashed border-amber-500/30 pl-[20px]">
            ...
            cardContent = (
              <div className="max-w-7xl mx-auto px-[15px] sm:px-6 lg:px-8 text-left space-y-6 pt-[10px]" id="products-grid-section">
                ...
                {filteredProducts.length === 0 ? (
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 p-[10px]">
            ...
            cardContent = (
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
                <section className="space-y-6 pt-8 mt-12 border-t border-slate-900 border-dashed text-left">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 p-[10px]">
            ...
            cardContent = (
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
                <section className="space-y-6 pt-8 pb-[0px] border-t border-slate-900 border-dashed text-left">
                  <div className="flex items-end justify-between pb-2">
                    <EditableText 
                      sectionId={section.id} 
                      field="title" 
                  ...
                  <div className="relative overflow-hidden py-4 -mx-4 px-4 sm:mx-0 sm:px-0" id="featured-projects-slider">
                    <style>{`
                          ...
                          return (
                            ...
                            >
                              <div className="h-[220px] relative overflow-hidden group w-full">
                                ...
                                <img src={(proj.imageUrl || "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&q=80&w=800") || undefined} alt={proj.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500 block" referrerPolicy="no-referrer" onError={(e) => { (e.target as HTMLImageElement).src = 'https://via.placeholder.com/600x400?text=Greenia+Homes'; }} />
                              </div>
          ...
          return (
            <div 
              ...
              style={{
                paddingTop: section.id === 'products_filter' ? '2px' : ['latest_sales', 'recently_viewed'].includes(section.id) ? '0px' : section.id === 'products_grid' ? '10px' : `${section.paddingTop || 0}px`,
                paddingRight: section.id === 'products_filter' ? '0px' : undefined,
                paddingBottom: section.id === 'products_filter' ? '0px' : section.id === 'recently_viewed' ? '30px' : `${section.id === 'products_grid' ? 15 : (section.paddingBottom || 0)}px`,
