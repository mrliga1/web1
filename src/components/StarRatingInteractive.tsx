...
export default function StarRatingInteractive({
  ...
  return (
    <div className="flex flex-col items-start py-4 border-t border-slate-800/60 border-b">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="text-[11px] text-slate-300 font-medium flex items-center space-x-1 border-l border-slate-700/50 pl-3">
          <span className="text-white bg-amber-500/10 text-amber-500 px-1.5 py-0.5 rounded font-bold">{currentAvg.toFixed(1)}</span>
