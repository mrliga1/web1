      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-8 space-y-10">
          ...
          <div className="relative aspect-[16/9] overflow-hidden rounded-lg border border-slate-900 bg-slate-950">
            <img loading="eager" decoding="async" src={optimizeImageUrl(article.thumbnail) || undefined} alt={article.title} className="w-full h-full object-cover" referrerPolicy="no-referrer"
              // @ts-ignore
              fetchpriority="high" />
          </div>
            ...
            <div className="relative overflow-hidden pb-4 w-full flex group">
              <div className="flex gap-4 box-border animate-marquee pr-4 flex-nowrap">
                {(() => {
                  ...
                  >
                    <img loading="lazy" decoding="async" src={optimizeImageUrl(n.thumbnail) || undefined} alt={n.title} className="w-full h-40 sm:h-32 lg:h-24 object-cover rounded-lg" referrerPolicy="no-referrer" />
          ...
          <div className="bg-slate-900 border border-slate-850 p-[10px] rounded-lg space-y-4 shadow-xl">
            ...
            <div className="space-y-3">
              {sidebarNewestNews.map((n) => (
                ...
                >
                  <img loading="lazy" decoding="async" src={optimizeImageUrl(n.thumbnail) || undefined} alt={n.title} className="w-[45px] h-[45px] object-cover rounded shrink-0" referrerPolicy="no-referrer" />
