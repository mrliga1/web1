...
export default function App() {
  ...
  const handleNavigate = (newRoute: RouteState) => {
    ...
    if (newRoute.screen === "home") targetPath = "/";
      ...
      targetPath = `/product/${newRoute.productId}${newRoute.slug ? `-${newRoute.slug}` : ""}`;
    else if (newRoute.screen === "project-detail" && newRoute.projectId)
      targetPath = `/project/${newRoute.projectId}${newRoute.slug ? `-${newRoute.slug}` : ""}`;
    else if (newRoute.screen === "news-detail" && newRoute.newsId)
      targetPath = `/news/${newRoute.newsId}${newRoute.slug ? `-${newRoute.slug}` : ""}`;
