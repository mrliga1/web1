        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 text-left">
          ...
          <div className="space-y-6 lg:col-span-1 border-l border-border-inverse pl-0 lg:pl-10">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a href="https://www.facebook.com/greeniahomes" target="_blank" rel="noopener noreferrer" aria-label="Facebook Greenia Homes" className="w-10 h-10 rounded-full border border-white/40 flex items-center justify-center text-white/90 hover:bg-primary hover:text-text-inverse hover:border-primary hover:-translate-y-1 transition-all">
              ...
              <a href="https://www.youtube.com/@greeniahomes.vn" target="_blank" rel="noopener noreferrer" aria-label="YouTube Greenia Homes" className="w-10 h-10 rounded-full border border-white/40 flex items-center justify-center text-white/90 hover:bg-primary hover:text-text-inverse hover:border-primary hover:-translate-y-1 transition-all">
              ...
              <a href="https://www.tiktok.com/@greeniahomes.vn" target="_blank" rel="noopener noreferrer" aria-label="TikTok Greenia Homes" className="w-10 h-10 rounded-full border border-white/40 flex items-center justify-center text-white/90 hover:bg-primary hover:text-text-inverse hover:border-primary hover:-translate-y-1 transition-all">
              ...
              <a href="https://zalo.me/0932966700" target="_blank" rel="noopener noreferrer" aria-label="Zalo Greenia Homes" className="w-10 h-10 rounded-full border border-white/40 flex items-center justify-center text-white/90 hover:bg-primary hover:text-text-inverse hover:border-primary hover:-translate-y-1 transition-all">
